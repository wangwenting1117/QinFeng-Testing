...
public class BaseAction {
	...
	public void click(AndroidElement elemnet) {
		elemnet.click();
	...
	public void type(AndroidElement element, String context) {
	...
	// 元素间的滑动
	public void swip(AndroidElement fromEle, WebElement toEle) {
